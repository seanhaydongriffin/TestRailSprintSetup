...
namespace SharedProject
{
    class DBConnect
    {
        ...
        {
            server = AppConfig.Get("CoPilotDatabaseHostname");                             // "workstation54";
            //database =                                                            // "control_automation_machine";
            uid = AppConfig.Get("CoPilotDatabaseUsername");                                // "auto";
//            password = StringCipher.Decrypt(AppConfig.Get("CoPilotDatabasePassword"));     // "janison";
            password = AppConfig.Get("CoPilotDatabasePassword");                            // "janison";
